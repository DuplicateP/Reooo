    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                ...
                cc1 = f'[📕]Pᴅғ Iᴅ : {str(count).zfill(3)}\n**Fɪʟᴇ Tɪᴛʟᴇ :** `{name1} .pdf`\n<pre><code>**📚 Bᴀᴛᴄʜ Nᴀᴍᴇ :** {b_name}</code></pre>\n\n**🚀 Exᴛʀᴀᴄᴛᴇᴅ Bʏ ➤ **`{CR}`\n'
                cczip = f'[📁]Zɪᴘ Iᴅ : {str(count).zfill(3)}\n**Zɪᴘ Tɪᴛʟᴇ :** `{name1} .zip`\n<pre><code>**📚 Bᴀᴛᴄʜ Nᴀᴍᴇ :** {b_name}</code></pre>\n\n**🚀 Exᴛʀᴀᴄᴛᴇᴅ Bʏ ➤ **`{CR}`\n' 
                ccimg = f'[🖼️]Iᴍɢ Iᴅ : {str(count).zfill(3)}\n**Iᴍᴀɢᴇ Tɪᴛʟᴇ :** `{name1} .jpg`\n<pre><code>**📚 Bᴀᴛᴄʜ Nᴀᴍᴇ :** {b_name}</code></pre>\n\n**🚀 Exᴛʀᴀᴄᴛᴇᴅ Bʏ ➤ **`{CR}`\n'
                ccm = f'[🎵]Aᴜᴅɪᴏ Iᴅ : {str(count).zfill(3)}\n**Aᴜᴅɪᴏ Tɪᴛʟᴇ :** `{name1} .mp3`\n<pre><code>**📚 Bᴀᴛᴄʜ Nᴀᴍᴇ :** {b_name}</code></pre>\n\n**🚀 Exᴛʀᴀᴄᴛᴇᴅ Bʏ ➤ **`{CR}`\n'
                cchtml = f'[🌐]Hᴛᴍʟ Iᴅ : {str(count).zfill(3)}\n**Hᴛᴍʟ Tɪᴛʟᴇ :** `{name1} .html`\n<pre><code>**📚 Bᴀᴛᴄʜ Nᴀᴍᴇ :** {b_name}</code></pre>\n\n**🚀 Exᴛʀᴀᴄᴛᴇᴅ Bʏ ➤ **`{CR}`\n'
